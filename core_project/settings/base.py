"""
Django base settings for core_project project.
"""
...
# CSRF settings
CSRF_TRUSTED_ORIGINS = config('CSRF_TRUSTED_ORIGINS', default='', cast=lambda x: [s.strip() for s in x.split(',') if s.strip()])
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Multi-Brand Inventory API',
    'DESCRIPTION': 'REST API for multi-brand inventory management system',
    'VERSION': '1.0.0',
